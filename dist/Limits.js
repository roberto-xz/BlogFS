...
export const BLOCK_SESSION_SIZE = BLOCK_SESSION_LABEL_SIZE +
...
export const REGISTER_SESSION_SIZE = REGISTER_SESSION_STATS_SIZE +
...
export const DATA_FILE_HEAD_SIZE = DATA_BLOCK_COUNT +
...
//
export function calculate_meta_size(blockCount, registerPerBlock) {
